...
public class ReminderUtilities {
    ...
    private static final String REMINDER_JOB_TAG = "task-reminder-tag";

    private static boolean sInitialized;

    synchronized public static void scheduleTaskReminder(@NonNull final Context context) {
        if(sInitialized) return;
        Driver driver = new GooglePlayDriver(context);
        FirebaseJobDispatcher firebaseJobDispatcher = new FirebaseJobDispatcher(driver);
        Job taskReminderJob = firebaseJobDispatcher.newJobBuilder()
        ...
        firebaseJobDispatcher.schedule(taskReminderJob);
        sInitialized = true;
    }
